(
  ...
  (problem instance-2)
  (:domain rover)
  (:objects waypoint0 rover0 waypoint5 camera4 rover4store rover1store colour waypoint6 camera5 rover1 rover3 low_res waypoint7 waypoint1 general rover2 waypoint3 objective1 camera1 rover3store camera2 rover4 camera3 objective0 objective2 camera0 rover2store waypoint2 waypoint4 rover0store high_res)
  (
    :init
