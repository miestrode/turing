(
  ...
  (problem instance-5)
  (:domain rover)
  (:objects waypoint0 objective4 camera4 rover4store rover3 camera1 objective6 camera2 rover4 camera3 objective0 camera0 rover2store high_res rover0 waypoint5 rover1store colour waypoint6 camera5 objective5 rover1 low_res waypoint7 waypoint1 general rover2 waypoint3 objective1 rover3store objective2 objective3 waypoint2 waypoint4 rover0store)
  (
    :init
    ...
    (empty rover2store)
    (objective__________________ objective6)
    ...
    (objective__________________ objective5)
    ...
    (objective__________________ objective4)
